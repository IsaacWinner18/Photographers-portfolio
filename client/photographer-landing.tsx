...
const Button = ({
  ...
  const variants = {
    ...
    outline:
      "border border-gray-600 text-gray-300 hover:bg-gray-700/50 hover:text-white",
  };
...
const Card = ({
  ...
  <div
    className={`rounded-xl border border-gray-700/50 bg-gray-800/50 backdrop-blur-sm shadow-lg ${className}`}
  >
    {children}
  </div>
);
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-slate-900">
      ...
      >
        <div className="container mx-auto px-4 flex h-16 items-center justify-between">
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button className="bg-blue-600 hover:bg-blue-700 border-0 text-white font-semibold">
              Book Session
            </Button>
          </motion.div>
        </div>
      ...
      <main className="flex-1 relative">
        {/* Hero Section */}
        <section id="home" className="relative w-full py-6 overflow-hidden">
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              ...
              >
                <div className="space-y-4">
                  ...
                  >
                    Professional photography services that tell your unique
                    story. From weddings to portraits, I create timeless
            ...
            >
              <div className="space-y-4">
                ...
                <p className="max-w-[900px] text-gray-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed font-['Inter']">
                  From intimate portraits to grand celebrations, I bring
        ...
        <section
          id="gallery"
          className="w-full py-12 md:py-24 lg:py-32 relative overflow-hidden bg-gray-800/30"
        >
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <motion.div
            ...
            <div className="relative">
              ...
              <div className="flex space-x-2 overflow-hidden">
                ...
                >
                  {[...galleryImages.slice(8), ...galleryImages.slice(8)].map(
                    (image, index) => (
                      <div
                        key={`row3-${index}`}
        ...
        >
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Badge className="bg-gray-500/20 text-gray-300 border border-gray-500/30 px-4 py-2">
                Client Love
              </Badge>
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-white font-['Inter']">
                What My
                    ...
                    <Card className="bg-gray-800/50 backdrop-blur-sm border-gray-700/50">
                      <CardHeader>
                        <div className="flex items-center space-x-1">
                          {[
                            ...Array(
                              testimonials[currentTestimonial * 3]?.rating || 5
                            ),
                          ].map((_, i) => (
                            <Star
                              key={i}
                      ...
                      <CardContent>
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="font-medium text-white">
                              {testimonials[currentTestimonial * 3]?.name}
                            </p>
                            <p className="text-sm text-gray-400">
                              {testimonials[currentTestimonial * 3]?.role}
                            </p>
                          </div>
                        </div>
                      </CardContent>
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            ...
            <div className="mx-auto grid max-w-6xl items-center gap-8 lg:grid-cols-3">
              {[
                ...
                >
                  <Card
                    className={`relative overflow-hidden bg-gray-800/50 backdrop-blur-sm border-gray-700/50 hover:bg-gray-700/50 transition-all duration-300 ${
            ...
            >
              <div className="space-y-4">
                ...
                <motion.p
                  ...
                  viewport={{ once: true }}
                >
                  Let's create something beautiful together. Book your session
                  today and let me help you preserve your most precious moments.
                </motion.p>
              </div>
              <motion.div
                className="flex flex-col gap-4 min-[400px]:flex-row"
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid gap-8 lg:grid-cols-4">
            ...
            >
              ...
              <p className="text-sm text-gray-400 font-['Inter']">
                Professional photography services capturing life's most
                beautiful moments with artistic flair and emotional depth.
              </p>
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  {section.links.map((link) => (
                    <li key={link}>
                      <Link
                        href="#"
                        className="hover:text-blue-400 transition-colors font-['Inter']"
                      >
                        {link}
                      </Link>
                    </li>
          ...
          >
            <p className="font-['Inter']">
              &copy; {new Date().getFullYear()} LensCapture. All rights
              reserved.
            </p>
          </motion.div>
        </div>
